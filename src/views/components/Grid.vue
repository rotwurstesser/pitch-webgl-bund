<template>
  <div class="space-y-6">
    ...
    >
      <div
        class="overflow-y-auto scrollbar-w-2 scrollbar-track-gray-lighter scrollbar-thumb-rounded scrollbar-thumb-gray scrolling-touch lg:max-h-sm"
      >
        <table class="w-full text-left table-collapse">
          <thead>
            <tr>
              <th
                class="z-20 sticky top-0 text-sm font-semibold text-gray-700 bg-gray-100 p-0"
              >
          ...
          <tbody class="align-baseline">
            <tr>
              <td
                class="p-2 font-mono text-xs text-purple-700 whitespace-no-wrap"
              >
                .grid-cols-1
              </td>
              <td class="p-2 font-mono text-xs text-blue-700 whitespace-pre">
                grid-template-columns: repeat(1, minmax(0, 1fr));
              </td>
            </tr>
            <tr>
              <td
                class="p-2 font-mono text-xs text-purple-700 whitespace-no-wrap border-t border-gray-200"
              >
                .grid-cols-2
              </td>
              <td
                class="p-2 font-mono text-xs text-blue-700 whitespace-pre border-t border-gray-200"
              >
    ...
    <p>
      Use the
      <code>grid-cols-{n}</code> utilities to create grids with
      <em>n</em> equally sized columns.
    </p>
    ...
    <h3>Responsive</h3>
    <p>
      To control the columns of a grid at a specific breakpoint, add a
      <code>{screen}:</code>
      prefix to any existing grid-template-columns utility. For example, use
      <code>md:grid-cols-6</code>
      to apply the
      <code>grid-cols-6</code> utility at only medium screen sizes and above.
    </p>
    <hr />
    ...
    <div
      class="mt-0 border-t border-b border-gray-300 overflow-hidden relative"
    >
      <div
        class="overflow-y-auto scrollbar-w-2 scrollbar-track-gray-lighter scrollbar-thumb-rounded scrollbar-thumb-gray scrolling-touch"
      >
        <table class="w-full text-left table-collapse">
          <thead>
            <tr>
    ...
    <h3>Usage</h3>
    <p>
      Use the <code>grid-rows-{n}</code> utilities to create grids with
      <em>n</em> equally sized rows.
    </p>
    <code-loader lang="html">
    ...
    <h3>Responsive</h3>
    <p>
      To control the rows of a grid at a specific breakpoint, add a
      <code>{screen}:</code> prefix to any existing grid-template-rows utility.
      For example, use <code>md:grid-rows-6</code> to apply the
      <code>grid-rows-6</code>
