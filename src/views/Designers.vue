<template>
  <div>
    ...
    <p class="mb-3">
      The design system is based on assets created with Figma, a well known UI design tool in the designer community. For every component description in this documentation, you will find a direct link to the related Figma asset. If you're a Sketch user, you can download a Sketch library containing all the assets.
    </p>
